...
- (void)stepBlockView:(StepBlockView *)stepBlockView deleteStepIndex:(NSString *)stepIndex;
- (void)stepBlockView:(StepBlockView *)stepBlockView requestStepIndex:(NSString *)stepIndex;
@end
